package com.gajeeldev.instagramclone.data

import com.gajeeldev.instagramclone.domain.model.User
import com.gajeeldev.instagramclone.domain.repository.AuthenticationRepository
import com.gajeeldev.instagramclone.util.Constants.COLLECTION_NAME_USERS
...
class AuthenticationRepositoryImpl @Inject constructor(
    ...
    override suspend fun isUserAuthenticatedIntoFirebase(): Boolean {
    ...
    override suspend fun firebaseSignUp(
        ...
        try {
            ...
            if (operationSuccessful) {
                ...
                firestore.collection(COLLECTION_NAME_USERS).document(userId).set(obj).addOnSuccessListener {
                    operationSuccessful = true
                }.await()
